...
1. **创建失败的测试用例**
   ...
   - 没有测试框架就写一次性测试脚本
   - 修复前必须先有测试
   - 使用 `using-superpowers:test-driven-development` 技能来编写规范的失败测试
...
**相关技能：**
- **using-superpowers:test-driven-development** - 用于创建失败测试用例（第四阶段，第 1 步）
- **using-superpowers:verification-before-completion** - 在宣称成功之前验证修复确实有效
