...
**注意：** 告诉你的人类伙伴，Superpowers 在有子代理支持时效果好得多。如果在支持子代理的平台上运行（如 Claude Code 或 Codex），其工作质量会显著提高。如果子代理可用，请使用 using-superpowers:subagent-driven-development 而非此技能。
...
- **必需子技能：** 使用 using-superpowers:finishing-a-development-branch
...
**必需的工作流技能：**
- **using-superpowers:using-git-worktrees** - 必需：开始前建立隔离的工作空间
- **using-superpowers:writing-plans** - 创建此技能要执行的计划
- **using-superpowers:finishing-a-development-branch** - 所有任务完成后收尾开发
